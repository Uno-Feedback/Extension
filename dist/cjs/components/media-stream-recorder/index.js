...
const video_preview_1 = require("../video-preview");
    ...
    constructor(options) {
        ...
        this.renderStream = (stream) => {
            ...
            this.startRecording(stream).then(recordedChunks => {
                ...
                // Fire observer
                observable_1.default.fire("setRecordState", false);
                observable_1.default.fire("closeWidget");
                // Preview of video file
                (0, video_preview_1.default)(recordedBlob);
...
exports.default = MediaStreamRecorder;
