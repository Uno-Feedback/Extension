(() => {
  ...
  var playIcon =
    '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 12V8.44002C4 4.02002 7.13 2.21002 10.96 4.42002L14.05 6.20002L17.14 7.98002C20.97 10.19 20.97 13.81 17.14 16.02L14.05 17.8L10.96 19.58C7.13 21.79 4 19.98 4 15.56V12Z" fill="white"/></svg>';
  var pauseIcon =
  ...
  var appendVideoToModal = (fileName, fileSize) => {
    modal_default(
      createTitle(
        `${lang.en.videoPreview.title} <small>(${fileName} - ${fileSize})</small>`
      ),
      () => {}
    ).then((modalContent) => {
  ...
  var initialInnerElements4 = (recordedBlob) =>
    __awaiter4(void 0, void 0, void 0, function* () {
      ...
      footer2.classList.add("uno-video-footer");
      ...
      footer2.appendChild(confirmationButton);
      videoWrapper.appendChild(footer2);
    });
  var videoPreview = (recordedBlob) => {
    const fileSize = formatBytes2(recordedBlob.size, 2);
    const fileName = createName2();
    initialInnerElements4(recordedBlob).then(() => {
